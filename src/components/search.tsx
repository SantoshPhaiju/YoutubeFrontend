        ...
        >
          <div className="flex justify-end items-center gap-0  h-full w-full">
                  ...
                  <FormControl>
                    <div className="relative w-full h-full">
                      ...
                      <Input
                        ...
                        className={cn(
                          `px-4 h-full border border-gray-300 focus-visible:ring-transparent focus-visible:border-purple-900 z-50 rounded-l-full text-[14px] md:text-[16px] focus:shadow-[inset_0_1px_4px_rgba(0,0,0,0.2)] focus-visible:shadow-[inset_0_1px_4px_rgba(0,0,0,0.2)]`,
                          {
            ...
            <Button
              ...
              variant="secondary"
              size="icon"
              className="border-r h-full border-gray-300 pl-1 w-15 bg-gray-100 border-t border-b rounded-r-full px-4 md:px-8 cursor-pointer"
            >
