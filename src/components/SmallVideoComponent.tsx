...
const SmallVideoComponent = ({ video }: { video: any }) => {
  return (
    <div className={cn(`video w-full cursor-pointer`)}>
      ...
      <div className="details py-1 pt-2.5 flex">
        <div className="flex flex-col gap-0.5 px-1 w-full">
          <div className="title text-sm text-black font-medium line-clamp-2 w-[98%]">
          ...
          <div className="flex flex-col w-full">
            ...
            {/*</div>*/}
            <div className="flex justify-start items-center gap-2 text-gray-600 text-xs">
              <div className="views">
