    ...
    return (
        <>
            <div className="commentSection">
                ...
                >
                    <div
                        className="w-full flex flex-col gap-4 h-auto bg-gray-50 hover:bg-gray-100 transition-all duration-300 rounded-lg px-4 py-2 pb-4">
                ...
                {showCommentModal === true && (
                    ...
                    >
                        <div className="comments relative">
                            <div
                                className="addcommentsection px-6 py-4 bg-white rounded-t-2xl border-t border-gray-100 fixed bottom-0 left-0 w-full z-50">
                            ...
                            <div
                                className="heading sticky top-0 left-0 bg-gray-50 z-30 px-6 py-4 border-b border-gray-300 flex-col text-lg font-medium flex justify-center items-start gap-2">
