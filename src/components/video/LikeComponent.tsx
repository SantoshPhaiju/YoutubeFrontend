    ...
    <>
      <div className="flex justify-between items-center rounded-full bg-gray-100">
        <button
          ...
          disabled={loading}
          className={cn(
            `flex justify-center border-r border-border items-center rounded-l-full gap-1 md:gap-2 p-1.5 px-3 md:p-2 md:px-4 hover:bg-gray-200`,
            {
        ...
        <button
          ...
          className={cn(
            `p-1.5 px-3 md:p-2 md:px-4 rounded-r-full hover:bg-gray-200`,
            {
              "cursor-not-allowed": loading,
              "cursor-pointer": !loading,
            },
