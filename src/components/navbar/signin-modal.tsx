...
//     }
//
//     const onSignup = (values: z.infer<typeof loginFormSchema>) => {
//         console.log(values);
//     }
//
//     return (
...
//                         <DialogTitle className={"font-inter hidden"}></DialogTitle>
...
//                             <TabsTrigger value="login" className={"w-full cursor-pointer"}>Login</TabsTrigger>
//                             <TabsTrigger value="signup" className={"w-full cursor-pointer"}>Signup</TabsTrigger>
//                         </TabsList>
...
//                                                     Email Address
//                                                 </FieldLabel>
//                                                 <Input placeholder={"Enter your email"} {...field} id={field.name}
